          ...
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <Link to="home">
              <div className="container flex items-center space-x-2">
                <h2 className="text-2xl font-bold">Ferdinsah</h2>
              </div>
            </Link>
            <div className="md:hidden flex">
              <button
                className="p-2 text-gray-700 bg-white rounded-md outline-none focus:border-gray-400 focus:border"
              ...
              {NAV_ITEMS.map((item, idx) => {
                return (
                  <Link
                    ...
                    to={item.page}
                    className={
                      "block lg:inline-block text-dark hover:text-neutral-800 underline-offset-auto dark:text-neutral-100"
                    }
                    activeClass="active"
                    spy={true}
                    smooth={true}
